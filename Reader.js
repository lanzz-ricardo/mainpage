...
function initToolBarStructure() {
    ...
    topIcon.style.fontSize = Math.round(window.reader.info.toolbarSize * 0.01).toString() + 'pt'
    bottomIcon.className = 'iconfont icon-down'
    bottomIcon.style.fontSize = Math.round(window.reader.info.toolbarSize * 0.01).toString() + 'pt'
    recoverIcon.className = 'iconfont icon-huifu'
    recoverIcon.style.fontSize = Math.round(window.reader.info.toolbarSize * 0.01).toString() + 'pt'
    reloadIcon.className = 'iconfont icon-change'
    reloadIcon.style.fontSize = Math.round(window.reader.info.toolbarSize * 0.01).toString() + 'pt'
    originIcon.className = 'iconfont icon-original'
    originIcon.style.fontSize = Math.round(window.reader.info.toolbarSize * 0.01).toString() + 'pt'
